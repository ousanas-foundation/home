            ...
            <Container>
                ...
                <Navbar.Collapse id="responsive-navbar-nav">
                    <ul className="nav navbar-nav navbar-right ml-auto">
                        ...
                        <li className="nav-item"><Nav.Link eventKey="2" href="/learn">Learn</Nav.Link></li>
                        <li className="nav-item"><Nav.Link eventKey="3" href="/wallet">Katanga Wallet</Nav.Link></li>
                        <li className="nav-item"><Nav.Link eventKey="4" href="#safety">Community</Nav.Link></li>
                        ...
                        <li className="nav-item sign-in-btn"><Nav.Link eventKey="7" className="nav-link btn btn-red" href="#singin">Vote</Nav.Link></li>
                    </ul>
                </Navbar.Collapse>
            </Container>
        </Navbar>
